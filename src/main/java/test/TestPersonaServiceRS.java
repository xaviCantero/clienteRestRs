...
public class TestPersonaServiceRS {
    ...
    private static final String URL_BASE = "http://localhost:8080/sga-jee-web-seguridad/webservice";
    ...
    public static void main(String[] args) {
        ...
        //Recuperamos la persona recien agrega para luego modificarla y al final eliminarla
